...
> = {
  ...
  summary: { label: 'Professional Summary', description: 'A brief overview of your experience', icon: 'file-text', removable: false, defaultActive: true, defaultLocked: false, supported: true, unique: true },
  education: { label: 'Education', description: 'Degrees, institutions, and achievements', icon: 'graduation-cap', removable: false, defaultActive: true, defaultLocked: false, supported: true, unique: true },
  skills: { label: 'Technical Skills', description: 'Organized skill groups by category', icon: 'wrench', removable: false, defaultActive: true, defaultLocked: false, supported: true, unique: true },
  projects: { label: 'Selected Projects', description: 'Highlight your best work with cards', icon: 'folder-git2', removable: false, defaultActive: true, defaultLocked: false, supported: true, unique: true },
  focusAreas: { label: 'Focus Areas', description: 'Areas of expertise or interest', icon: 'target', removable: false, defaultActive: true, defaultLocked: false, supported: true, unique: true },
  certifications: { label: 'Certifications', description: 'Professional certifications and badges', icon: 'award', removable: false, defaultActive: true, defaultLocked: false, supported: true, unique: true },
  ...
  languages: { label: 'Languages', description: 'Spoken languages with proficiency', icon: 'globe', removable: true, defaultActive: true, defaultLocked: false, supported: true, unique: false },
  awards: { label: 'Awards', description: 'Honors, awards, and recognitions', icon: 'trophy', removable: true, defaultActive: true, defaultLocked: false, supported: true, unique: false },
  links: { label: 'Links', description: 'Important URLs and online profiles', icon: 'link', removable: true, defaultActive: true, defaultLocked: false, supported: true, unique: false },
